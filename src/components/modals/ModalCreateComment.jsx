  ...
  return (
    <>
      {commentoPadre ? (
        ...
        <Button variant="transparent" onClick={handleShow} className="mt-2 py-2 w-100 blackGold  rounded border opacity-75 shadowScale">
          Create a comment
        </Button>
      )}
          ...
          <div className="sezione">
            ...
            <Modal.Body>
              <Form onSubmit={e => handleSubmit(e)}>
                <Form.Group>
                  <Form.Control className="blackGold shadowScale" onChange={e => setTextComment(e.target.value)} value={textComment} as="textarea" rows={5} placeholder="Text" />
                </Form.Group>
